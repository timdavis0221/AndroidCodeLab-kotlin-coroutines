...
//        withContext(Dispatchers.IO) {
            try {
                ...
                // inform caller if network operation throw an exception
                throw TitleRefreshError("throw TitleRefreshError", cause)
            }

//            when (result.isSuccessful) {
//                true -> titleDao.insertTitle((Title(result.body()!!)))
//                false -> throw TitleRefreshError("fetch next title request was not successful", null)
//            }
//        }
    }
